      ...
      <Box my="xl" component="a" className="text-justify">
       {/*  Hero section*/}
        <div className="flex flex-col sm:flex-row gap-4 mt-6">
          ...
          <Card  shadow="xs"  padding="md" radius="md" style={{backgroundColor: ''}}>
          ...
          <Text >
          Our Company Project Management System is a powerful tool designed
           to streamline project management processes and enhance collaboration 
           within our organization. This document provides an overview of the system, 
           its features, and benefits for both developers and admin managers.
