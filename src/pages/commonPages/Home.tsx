    ...
    <Box my="xl" component="a" className="text-justify">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-6">
        <div className="w-full sm:w-2/3">
          <Card shadow="xs" padding="md" radius="md">
            ...
            <div className="p-4 ">
              <Text size="lg">
                A task management system is a tool or framework used for
                planning, tracking, and coordinating tasks within a team or
                project.
              </Text>
              <Text>
                A task management system is a tool or framework used for
                planning, tracking, and coordinating tasks within a team or
                project. A task management system is a tool or framework used
                for planning, tracking, and coordinating tasks within a team or
                project. A task management system is a tool or framework used
                for planning, tracking, and coordinating tasks within a team or
                project. A task management system is a tool or framework used
                for planning, tracking, and coordinating tasks within a team or
      ...
      <div className=" bg-fuchsia-50 mt-16">
        ...
        <div className=" p-8 bg-fuchsia-50 flex flex-col sm:flex-row  gap-8 mt-3">
          ...
          <Card>
            ...
            <Text size="lg">
              Break down projects into tasks, assign responsibilities, set due
              dates, and track progress with ease.
            </Text>
          </Card>
          <Card>
            ...
            <Text size="lg">
              ...
              allowing team members to share files, exchange messages, and
      ...
      <div className=" flex  flex-col sm:flex-row justify-between  mt-16 bg-slate-50">
        ...
        <div>
          ...
          <Text size="lg">
            We have make confortable working environments for developers in
            Terms of;
          </Text>
          <List
            spacing="xs"
